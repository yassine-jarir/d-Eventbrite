				...
				<nav class="gap-3 navbar navbar-expand">
					...
					<div class="top-menu ms-auto">
						<ul class="align-items-center gap-1 navbar-nav">
							...
							<li class="dropdown dropdown-app nav-item">
								<a class="dropdown-toggle dropdown-toggle-nocaret nav-link" data-bs-toggle="dropdown" href="javascript:;"><i class='bx-grid-alt bx'></i></a>
								<div class="p-0 dropdown-menu dropdown-menu-end">
									<div class="my-2 app-container p-2">
									  <div class="justify-content-center p-2 row-cols-3 gx-0 gy-2 row">
										 <div class="col">
										  <a href="javascript:;">
							...
							<li class="dropdown dropdown-large nav-item">
								<a class="position-relative dropdown-toggle dropdown-toggle-nocaret nav-link" href="#" data-bs-toggle="dropdown"><span class="alert-count">7</span>
								...
								<div class="dropdown-menu dropdown-menu-end">
									...
									<div class="header-notifications-list">
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												...
												<div class="flex-grow-1">
													<h6 class="msg-name">Daisy Anderson<span class="float-end msg-time">5 sec
												ago</span></h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="bg-light-danger text-danger notify">dc
												</div>
												<div class="flex-grow-1">
													<h6 class="msg-name">New Orders <span class="float-end msg-time">2 min
												ago</span></h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												...
												<div class="flex-grow-1">
													<h6 class="msg-name">Althea Cabardo <span class="float-end msg-time">14
												sec ago</span></h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												...
												<div class="flex-grow-1">
													<h6 class="msg-name">Account Created<span class="float-end msg-time">28 min
												ago</span></h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="bg-light-info text-info notify">Ss
												</div>
												<div class="flex-grow-1">
													<h6 class="msg-name">New Product Approved <span
												class="float-end msg-time">2 hrs ago</span></h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												...
												<div class="flex-grow-1">
													<h6 class="msg-name">Katherine Pechon <span class="float-end msg-time">15
												min ago</span></h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="bg-light-success text-success notify"><i class='bx bx-check-square'></i>
												</div>
												<div class="flex-grow-1">
													<h6 class="msg-name">Your item is shipped <span class="float-end msg-time">5 hrs
												ago</span></h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												...
												<div class="flex-grow-1">
													<h6 class="msg-name">New 24 authors<span class="float-end msg-time">1 day
												ago</span></h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												...
												<div class="flex-grow-1">
													<h6 class="msg-name">Peter Costanzo <span class="float-end msg-time">6 hrs
												ago</span></h6>
									...
									<a href="javascript:;">
										<div class="text-center msg-footer">
											<button class="w-100 btn btn-light">View All Notifications</button>
										</div>
									</a>
								</div>
							</li>
							<li class="dropdown dropdown-large nav-item">
								<a class="position-relative dropdown-toggle dropdown-toggle-nocaret nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> <span class="alert-count">8</span>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="bg-light rounded-circle cart-product">
					...
					<div class="px-3 dropdown user-box">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li><a class="d-flex align-items-center dropdown-item" href="javascript:;"><i class="bx bx-download fs-5"></i><span>Downloads</span></a>
							</li>
							<li>
