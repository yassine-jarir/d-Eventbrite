...
<footer class="shape-mockup-wrap footer-layout2">
    <div class="d-xl-block z-index-negative shape-mockup d-none" data-top="0%" data-left="0%">
        <img src="/assets/img/shapes/footer-2-1.png" alt="footer shape">
    </div>
    <div class="d-xl-block z-index-negative shape-mockup d-none" data-bottom="0%" data-right="0%">
                ...
                <div class="col-lg-4 col-md-6 col-xl-auto">
                    <div class="footer-widget widget">
                        ...
                        <div class="footer-logo">
                            <a href="index.html"><img src="/assets/img/logo-white.svg" alt="Eventino"
                                    class="logo"></a>
                        </div>
    ...
    <div class="container">
        <div class="copyright-wrap">
            <div class="justify-content-lg-between justify-content-center row">
                <div class="col-auto">
                    <p class="copyright-text">Copyright <i class="fa-copyright fal"></i> 2024 <a
