          ...
          foreach ($events as $event) {
            echo "
                    ...
                    <div class='event-style1'>
                            <div class='event-img'>
                                <img src='" . $event['event_image'] . "' alt='e 1 1'>
                            ...
                            <div class='event-content'>
                                <div class='event-meta'>
                                    <ul>
                                        <li>
                                            <span><i class='fas fa-clock'></i>" . $event['start_time'] . "AM - " . $event['end_time'] . "PM</span>
                                        </li>
                                        <li>
                                ...
                                <h3 class='event-title h5'><a href='event-details.html'>" . $event['title'] . "</a>
                                </h3>
      ...
      <div class="row">
        <div class="col-md-6 Business Art More">
          <div class="event-style3">
            <div class="event-img">
              <img src="assets/img/events/e-3-1.jpg" alt="e 1 1">
              <div class="event-tags">
