        ...
        <div class="auth-style">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="active nav-link" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"
          ...
          <div class="auth-social">
            ...
            <div class="footer-social style3">
              <a href="https://www.facebook.com/"><i class="fa-facebook-f fab"></i></a>
              <a href="https://www.google.com/"><i class="fa-google fab"></i></a>
              <a href="https://www.gmail.com/"><i class="fa-envelope fas"></i></a>
            </div>
          </div>
          <div class="tab-content" id="myTabContent">
            <div class="active fade show tab-pane" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
              tabindex="0">
...
<div class="newsletter-layout1">
  ...
  <div class="container">
    <form class="newsletter-form1">
      ...
      <img src="assets/img/shapes/ns-1-2.png" alt="shape" class="bottom-0 position-absolute end-0 shape">
      <div class="align-items-center justify-content-between g-4 row">
